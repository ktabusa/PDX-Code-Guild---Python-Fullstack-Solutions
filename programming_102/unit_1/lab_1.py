...
while True:
    ...
    # ---- users is not a variable previously set
    if user == computer:
        # ---- needed an extra closing paren here
        print("Looks like a tie")
    # check all cases if user is rock
    # ---- elif was used.  this needs to be an if statement
    if user == "rock":
        # check winning case
        if computer == "scissors":
            print("You win!")
        # check losing case
        # ---- loss case text should apply if the computer was paper, not rock as previously stated
        elif computer == "paper":
            print("Sorry, You lose.")
    # check all cases if user is paper
    elif user == "paper":
        # check winning case
        # ---- needed a ':' to follow rock for the conditional
        if computer == "rock":
            print("You win!")
        # check losing case
    ...
    # check all cases if user is scissors
        ...
        # check losing case
            ...
            # ---- uppercase Print statement needed to be changed to a lowercase
            print("Sorry, You lose.")